...
public class StartCSE360 extends Application {
        ...
        submitButton.setOnAction(e -> {
            try {
                if (databaseHelper.login(emailField.getText(), passwordField.getText(),Role.student)) {
                    Student.main(primaryStage, emailField.getText());
    ...
    public static void showStudentOptions(Stage primaryStage, String email) {
        ...
        searchArticleButton.setOnAction(e -> {
            ...
            showInfoDialog("Search Article", "Search functionality is under development.");
        });
        ...
        studentLayout.getChildren().addAll(mainLabel, searchArticleButton, sendGenericMessageButton, sendSpecificMessageButton, listArticlesByLevel, logoutButton);
