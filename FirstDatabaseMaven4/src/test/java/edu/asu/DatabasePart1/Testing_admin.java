...
public class Testing_admin {
    ...
    public void tearDown() throws SQLException {
        ...
        DatabaseHelper.connection.createStatement().execute("DELETE FROM special_group_members");
        DatabaseHelper.connection.createStatement().execute("DELETE FROM cse360users");
    }
